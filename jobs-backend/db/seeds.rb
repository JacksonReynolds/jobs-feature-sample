...
Job.create([
  {
    ...
    skills: ["JavaScript", "Ruby", "Rails", "Vue.js", "HTML", "CSS"].join(' '),
  ...
  {
    title: "Architect",
    skills: ["CAD", "Revit", "Residential and Commercial Design", "Building Codes"].join(' '),
  ...
  },
  {
    ...
    skills: ["Market Analysis", "Salespersonship", "Networking", "Presentation"].join(' '),
  ...
  },
  {
    ...
    skills: ["Knowledge of Anatomy", "Record Keeping", "Principles of Nutrition", "Affective Exercises", "Personal Training Techniques"].join(' '),
